<x-base-layout>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="computation_node" class="collapse show">
            <!--begin::Form-->
            <form id="computation_node_form" class="form" method="POST" action="{{route('computations.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="name" class="form-control form-control-lg form-control-solid {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Computation name" value="{{ old('name') }}"/>
                            @if ($errors->has('name'))
                    ...
                    <div class="row mb-6 mt-8">
                        ...
                        <div class="col-lg-8">
                            <input type="file" name="file"
                                   ...
                                   class="form-control form-control-lg form-control-solid {{ $errors->has('file') ? ' is-invalid' : '' }}">
                            @if ($errors->has('file'))
